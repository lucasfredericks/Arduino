...
// calculated voltage
float R1 = 300.0;    //resistor 1 value (Kohms)
float R2 = 51.0;    //resistor 2 value (Kohms)
float dividerAdj = (R2/(R1+R2));
float voltage;
float lastVoltage; //comparison value to reduce noise
String wmid = "WM1/"; //CHANGE THE INTEGER TO MATCH THE WINDMILL IDENTITY! e.g. "WM1/" or "WM2/" Everything else can stay the same between windmills.
