...
void loop()
{
  ...
  Serial.print(sensorValue); //print the value of A0
  Serial.print(","); // print label to serial monitor
  Serial.println(digitalValue*100); //print the value of D0 in the serial
